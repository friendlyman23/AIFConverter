...
App_Parse_Aif_Chunk(uint8 *Aif_FormChunk_Start, form_chunk *FormChunk)
{
    ...
    FormChunk->Address = CopyAddress(Aif_Index);
...
App_Parse_Aif_Chunk(uint8 *Aif_InstrumentChunk_DataStart, instrument_chunk *InstrumentChunk)
{
    ...
    InstrumentChunk->Address = Aif_Index;
        ...
        int CmdShow)
{
    ...
    int Aif_CommonChunk_BytesRead = App_Parse_Aif_Chunk(Aif_CommonChunk_Start, &CommonChunk);
